<x-admin-layout title="Add Speaker">
    ...
    <div class="mb-6 flex items-center gap-3">
        ...
        <div>
            <h1 class="text-2xl font-bold text-blue-900">Add New Speaker</h1>
            <p class="text-sm text-black/40 mt-0.5">Fill in the speaker details below.</p>
        </div>
    </div>
        ...
        <div class="bg-white rounded-2xl shadow p-7 mb-5">
            <div class="flex items-start gap-3 mb-6">
                ...
                <div>
                    ...
                    <p class="text-sm text-black/50">Complete all relevant fields for this speaker.</p>
                </div>
            </div>
